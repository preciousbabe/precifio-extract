...
/**
 * Export to CSV (pure function - no DB dependency)
 */
...
/**
 * QuickBooks export format (pure transformation)
 */
...
/**
 * Xero export format (pure transformation)
 */
export async function exportToXero(extraction) {
  return {
    ...
    Contact: {
      ...
      LastName:
        extraction.vendor_name?.split(' ').slice(1).join(' ') || ''
    },
...
/**
 * Save export record (BACKEND ONLY - uses Supabase service role)
 */
